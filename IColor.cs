namespace HappyNet.Kion
{
	public interface IColor
	{
		...
		static abstract IColor FromHSV(float h, float s, float v);
		...
		/// <returns>Your color scheme</returns>
		static abstract IColor FromRGB(byte r, byte g, byte b);
		...
		static T FromColor<T>(IColor color) where T : IColor
		{
			...
			{
				throw new NotImplementedException("Have no converter for this color scheme");
			}
		}
	}
}